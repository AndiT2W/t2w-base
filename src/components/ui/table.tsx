...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-[30px] whitespace-nowrap bg-muted/45 px-2 text-left align-middle text-[11px] font-semibold uppercase tracking-wide text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className,
    )}
    {...props}
  />
