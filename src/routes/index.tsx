...
import { AlertTriangle, CalendarClock, CheckSquare, Euro, Plus } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "Übersicht – TIME2WIN Eventverwaltung" },
      {
        name: "description",
        content:
          "Ops Command Center: KPI-Leiste für nächste Events, offene Aufgaben, Risiken und finanzielle Lücken plus dichte Eventtabelle.",
      },
...
function Uebersicht() {
  ...
  return (
    <div>
      <PageHeader
        titel="Übersicht"
        beschreibung="Ops Command Center · operative Tagesarbeit auf Demo-Daten"
        suche={{
          value: suche,
          onChange: setSuche,
